 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Et=1e3,_t=2,vt=4*60*60*1e3,At=.5;function ie(e,t=Et,n=_t){const r=t*Math.pow(n,e),a=Math.round(At*r*(Math.random()-.5)*2);return Math.min(vt,r+a)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ut{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(zt(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function zt(e){const t=e.getComponent();return t?.type==="VERSION"}const G="@firebase/app",le="0.13.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vn="firebase-heartbeat-database",An=1,O="firebase-heartbeat-store";let H=null;function Pe(){return H||(H=Me(vn,An,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(O)}catch(n){console.warn(n)}}}}).catch(e=>{throw I.create("idb-open",{originalErrorMessage:e.message})})),H}async function Sn(e){try{const n=(await Pe()).transaction(O),r=await n.objectStore(O).get(Ne(e));return await n.done,r}catch(t){if(t instanceof D)b.warn(t.message);else{const n=I.create("idb-get",{originalErrorMessage:t?.message});b.warn(n.message)}}}async function ue(e,t){try{const r=(await Pe()).transaction(O,"readwrite");await r.objectStore(O).put(t,Ne(e)),await r.done}catch(n){if(n instanceof D)b.warn(n.message);else{const r=I.create("idb-set",{originalErrorMessage:n?.message});b.warn(r.message)}}}function Ne(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge=new Map;function Ke(e,t){const n=k(e);Ye(n,t),Kn(n,t)}function Ye(e,t){const n=Ge.get(e);if(n)for(const r of n)r(t)}function Kn(e,t){const n=Yn();n&&n.postMessage({key:e,fid:t}),Jn()}let v=null;function Yn(){return!v&&"BroadcastChannel"in self&&(v=new BroadcastChannel("[Firebase] FID Change"),v.onmessage=e=>{Ye(e.data.key,e.data.fid)}),v}function Jn(){Ge.size===0&&v&&(v.close(),v=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $="analytics",wr="firebase_id",Er="origin",_r=60*1e3,vr="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",ne="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qr{constructor(t){this.app=t}_delete(){return delete C[this.app.options.appId],Promise.resolve()}}let C={},me=[];const be={};let z="dataLayer",Gr="gtag",ye,rt,Ie=!1;function Kr(){const e=[];if(mt()&&e.push("This is a browser extension environment."),bt()||e.push("Cookies are not available."),e.length>0){const t=e.map((r,a)=>`(${a+1}) ${r}`).join(" "),n=g.create("invalid-analytics-context",{errorInfo:t});f.warn(n.message)}}function Yr(e,t,n){Kr();const r=e.options.appId;if(!r)throw g.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)f.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw g.create("no-api-key");if(C[r]!=null)throw g.create("already-exists",{id:r});if(!Ie){Cr(z);const{wrappedGtag:i,gtagCore:s}=Mr(C,me,be,z,Gr);rt=i,ye=s,Ie=!0}return C[r]=Wr(e,me,be,t,ye,z,n),new qr(e)}function Jr(e=_n()){e=Ce(e);const t=N(e,$);return t.isInitialized()?t.getImmediate():Xr(e)}function Xr(e,t={}){const n=N(e,$);if(n.isInitialized()){const a=n.getImmediate();if(R(t,n.getOptions()))return a;throw g.create("already-initialized")}return n.initialize({options:t})}function Zr(e,t,n,r){e=Ce(e),Ur(rt,C[e.app.options.appId],t,n,r).catch(a=>f.error(a))}const we="@firebase/analytics",Ee="0.10.17";function Qr(){A(new E($,(t,{options:n})=>{const r=t.getProvider("app").getImmediate(),a=t.getProvider("installations-internal").getImmediate();return Yr(r,a,n)},"PUBLIC")),A(new E("analytics-internal",e,"PRIVATE")),w(we,Ee),w(we,Ee,"esm2017");function e(t){try{const n=t.getProvider($).getImmediate();return{logEvent:(r,a,i)=>Zr(n,r,a,i)}}catch(n){throw g.create("interop-component-reg-failed",{reason:n})}}}Qr();const ea={apiKey:"AIzaSyAjq3V5MucSgKB-jrnL9ueiZHE__ggwhz4",authDomain:"santre-58376.firebaseapp.com",projectId:"santre-58376",storageBucket:"santre-58376.firebasestorage.app",messagingSenderId:"964382459962",appId:"1:964382459962:web:ba6e146a76d8e0410b8d03",measurementId:"G-HZ53B6Y9JZ"};function ta(){const e=$e(ea);let t=null;return typeof window<"u"&&(t=Jr(e)),{app:e,analytics:t}}export{ta as initFirebase};
